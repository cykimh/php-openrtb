        ...
        if (array_key_exists($item, $this->attributes)) {
            if (isset($this->attributes[$item]['type'])) {
                ...
                if ($this->validateType($value, $type, $subType)) {
                    ...
                    var_dump("value : ", $value, "type : ", $type, "subtype : ", $subType);
//                    exit;
            ...
            $this instanceof \openrtb\BidResponse\Ext
            || $this instanceof \openrtb\BidRequest\Ext
            || $this instanceof \openrtb\NativeAdRequest\Ext
            || $this instanceof \openrtb\NativeAdResponse\Ext
        ) {
            $this->data[$item] = $value;
        } else {
    ...
    protected function isModel($type) {
        return preg_match('/^openrtb\\\/', $type);
    }
